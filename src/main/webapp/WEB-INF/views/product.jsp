...
<div id="wrap">
	...
	<div id="container" class="camp_wrap list">
		...
		<section class="new_area">
			<div class="container">
				<h3 class="comm_tit"> 인기있는 <b>도안</b></h3>
				<div class="camp_slide">
					...
					<a class="cp_thumb" >
					<img src="${root }resources/images/test/남색.PNG" alt=""/>
					
					<h2>$56</h2>
					<p>Easy Polo Black Edition</p>
					<img src="${root }resources/images/test/보라색.PNG" >
					<img src="${root }resources/images/test/주황색.png" >
							...
							<c:when test="${!empty newCampList}">
								...
								<li class="swiper-slide">
									<a class="cp_thumb" href="${root}camp/detail?canum=${camp.canum}&caaddrsel=${camp.caaddrsel}">
										...
										<c:if test="${!empty camp.caphoto && empty image}"><img src="${root }resources/images/test/남색.PNG" alt="${camp.caname}"></c:if>
		...
		<section class="tab_area">
			<div class="container">				
				<ul class="tab_list">
					...
					<li><a href="?caaddrsel=서울"<c:if test="${param.caaddrsel eq '서울'}"> class="on"</c:if>>사각/원형 비즈</a></li>
					<li><a href="?caaddrsel=경기도"<c:if test="${param.caaddrsel eq '경기도'}"> class="on"</c:if>>소품</a></li>
					<li><a href="?caaddrsel=강원도"<c:if test="${param.caaddrsel eq '강원도'}"> class="on"</c:if>>액자</a></li>
					...
					<c:when test="${!empty campList}">
						...
						<li>
							<a class="cp_thumb" href="${root}camp/detail?canum=${camp.canum}&caaddrsel=${camp.caaddrsel}">
								...
								<c:if test="${!empty camp.caphoto && !empty image}"><img src="${upload}/${image}" alt="${camp.caname}"></c:if>
								<c:if test="${empty camp.caphoto && empty image}"><img src="${root }resources/images/test/남색.PNGkkkkkkkkkkk" alt="${camp.caname}"></c:if>
